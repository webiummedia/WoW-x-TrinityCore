...
-- -------------------------------------------------------- 
-- 2013_12_01_00_auth_rbac_permissions.sql 
-- -------------------------------------------------------- 
DELETE FROM `rbac_permissions` WHERE `id`=614;
 
 
-- -------------------------------------------------------- 
-- 2013_12_01_01_auth_rbac_permissions.sql 
-- -------------------------------------------------------- 
DELETE FROM `rbac_permissions` WHERE `id` IN (631,632);
 
 
-- -------------------------------------------------------- 
-- 2014_01_19_00_auth_rbac_permissions.sql 
-- -------------------------------------------------------- 
SET @id = 777;
...
-- -------------------------------------------------------- 
-- 2014_01_19_01_auth_rbac_permissions.sql 
-- -------------------------------------------------------- 
SET @oldId = 775;
SET @id = 777;
